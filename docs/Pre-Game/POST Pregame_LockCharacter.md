...
## Visit <https://valapidocs.techchrism.me/endpoint/lock-character> for the latest documentation (and update your links if possible)
...
Method: `POST`  
URL: `https://glz-{region}-1.{shard}.a.pvp.net/pregame/v1/matches/{pre-game match id}/lock/{agent id}`  
Headers:
