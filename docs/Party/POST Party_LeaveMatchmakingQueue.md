...
## Visit <https://valapidocs.techchrism.me/endpoint/leave-matchmaking-queue> for the latest documentation (and update your links if possible)
...
Method: `POST`  
URL: `https://glz-{region}-1.{shard}.a.pvp.net/parties/v1/parties/{party id}/matchmaking/leave`  
Headers:
