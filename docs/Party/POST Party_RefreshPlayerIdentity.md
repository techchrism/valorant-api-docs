...
## Visit <https://valapidocs.techchrism.me/endpoint/refresh-player-identity> for the latest documentation (and update your links if possible)
...
Method: `POST`  
URL: `https://glz-{region}-1.{shard}.a.pvp.net/parties/v1/parties/{party id}/members/{puuid}/refreshPlayerIdentity`  
Headers:
...
### Response Format:
```ts
type RefreshPlayerIdentityResponse = {
    /** Party ID */
    ID: string;
    MUCName: string;
    VoiceRoomID: string;
