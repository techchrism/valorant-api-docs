...
export const configEndpoint = {
    ...
    responses: {
        '200': z.object({
            LastApplication: z.string().datetime({offset: true}).transform(val => new Date(val)).describe('Date in ISO 8601 format with sub-second precision'),
            Collapsed: z.object({
                ...
                'SERVICEURL_GALBS_QUERY': z.string(),
                ...
                'avs.enabled': stringBooleanSchema,
                ...
                'homescreen.patchnotes.baseURL': z.string(),
                'homescreen.promo.enabled': stringBooleanSchema,
                'homescreen.promo.key': z.string(),
                'homescreen.webtile.baseURL': z.string(),
                ...
                'playscreen.premier.enabled': stringBooleanSchema,
                'premier.conferences.fetch.enabled': stringBooleanSchema,
                'premier.leaderboardTab.enabled': stringBooleanSchema,
                'premier.matchHistoryTab.enabled': stringBooleanSchema,
                'premier.playscreenflow.enabled': stringBooleanSchema,
                'premier.rosterEligibilityCheck.enabled': stringBooleanSchema,
                'premier.seasons.activeseason.enabled': stringBooleanSchema,
                'premier.seasons.fetch.enabled': stringBooleanSchema,
                ...
                'telemetry.rtp.eventendpoint': z.string(),
                'telemetry.rtp.rfc190scope': z.string(),
                'temp.voice.allowmuting': stringBooleanSchema,
                'tournaments.enabled': stringBooleanSchema,
                'tournaments.pregame.enabled': stringBooleanSchema,
