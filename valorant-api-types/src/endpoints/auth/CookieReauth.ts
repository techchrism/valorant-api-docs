...
export const cookieReauthEndpoint = {
    ...
    description: 'Get a new token using the cookies from a previous authorization request\n' +
        'Use the saved cookies from [Auth Request]({{#linkto}}Auth Request{{/linkto}}) (specifically the `ssid` cookie). The token can be found from the url this request redirects to.\n' +
